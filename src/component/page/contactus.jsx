                            ...
                            <Form className="contact_us_form">
                                <div className="contact_info_item d-flex ">
                                    <div className="contact_info_inner">
                                        ...
                                        <div className="contact_info_inner_txt">
                                            <h4>Contact Info</h4>
                                            <p className="m-0">Open a chat or give us call at</p>
                                ...
                                <div className="contact_us_form_item ps-4 d-flex justify-content-between align-items-center ">
                                    <div className="contact_us_form_inner">
                                        <Form.Group  >
                                            <Form.Label className='form-lable'>Your Full Name</Form.Label>
                                            <Form.Control required type="text" placeholder="your Full Name" className="form-control" />
                                        </Form.Group>
                                    </div>
                                    <div className="contact_us_form_inner">
                                        <Form.Group  >
                                            <Form.Label className='form-lable'>Enter Email Address</Form.Label>
                                            <Form.Control required type="text" placeholder="Enter Email Address" className="form-control" />
                                        </Form.Group>
                                    </div>
                                </div>
                                <div className="contact_us_form_item ps-4  d-flex justify-content-between align-items-center">
                                ...
                                <div className="contact_us_form_item ps-4 d-flex">
                                    <div className="contact_us_form_inner">
                                        <Form.Group  >
                                            <Form.Label className='form-lable'>Write Message</Form.Label>
                                            <Form.Control as="textarea" rows="5" required type="text" placeholder="your Full Name" className="form-control" />
                                        </Form.Group>
                                    </div>

                                </div>
                                <div class="contact_us_form_item_btn  ps-4">
